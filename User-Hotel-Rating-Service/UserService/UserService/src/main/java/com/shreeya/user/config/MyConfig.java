...
public class MyConfig {
    ...
    @Bean
    @LoadBalanced
    public RestTemplate restTemplate() {  //restTemplate Interceptor addition
    ...
    public OAuth2AuthorizedClientManager manager(
        ...
        //we need this manager to intercept the request and add token to it in feignClientInterceptor.java
